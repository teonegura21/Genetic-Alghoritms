...
void HC_BI(vector<bool>& pcurent, int& puncte_vizitate) 
{
    puncte_vizitate++;
    ...
    HC_BI(pcurent, puncte_vizitate);
}

void HC_FI(vector<bool>& pcurent, int& puncte_vizitate)
{
    puncte_vizitate++;
